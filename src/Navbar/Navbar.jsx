...
const Navbar = () => {
    ...
    <Link to='/story'><button className='lg:px-4 lg:py-1 lg:text-xl text-gray-800 hover:bg-black hover:text-white font-serif rounded-md'>Story</button></Link>
    <Link to='/letter'><button className='lg:px-4 lg:py-1 lg:text-xl text-gray-800 hover:bg-black hover:text-white font-serif rounded-md'>Letter</button></Link>
